...
なお、`System.Environment`モジュールが提供する他の関数については、[こちらのドキュメント](https://hackage.haskell.org/package/base/docs/System-Environment.html)をご覧ください。
...
`System.Environment`で使える他の関数は[こちらのドキュメント][1]をご覧ください。
